...
def write_to_html(issue_set):
    ...
    html_string += issue_open_header + issue_open_body + issue_closed_header + issue_closed_body

    # Outputting to our a newly opened html file
    html_file = open("issues.html", "w")
...
def generate_issue_html(issue_list):
    ...
    :return: An HTML formatted output containing a brief overview of the Issue object's metadata.
    """
    html_string = ''
